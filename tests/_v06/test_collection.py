...
def test_scene_new() -> None:
    ...
    transform_a_world = Translation(
        translation=(0, 0),
        input=CoordinateSystemIdentifier(path="image_a", name=physical_coord_system.name),
        output=CoordinateSystemIdentifier(name="world"),
    )
    transform_b_world = Translation(
        translation=(0, 256),
        input=CoordinateSystemIdentifier(path="image_b", name=physical_coord_system.name),
        output=CoordinateSystemIdentifier(name="world"),
    )
    ...
    assert coord_transform_0.input.path == "image_a"
    ...
    assert coord_transform_1.input.path == "image_b"
