...
class Image(BaseGroupv06[ImageAttrs]):
    ...
    # TODO: this code was copy-pasted from v05 and now needs to be adapted to v06.
    #  In particular the "axes" are not used anymore.
    # @classmethod
    # def new(
    #     cls,
    #     *,
    ...
    #         - they exist
    #         - they are not groups
    #         - they have dimensionality consistent with the number of axes defined in
    #           the metadata.
    #     """
